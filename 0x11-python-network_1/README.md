...
```
$ guillaume@ubuntu:~/0x11$ ./10-my_github.py edwardmuss random_pwd
6069359
$ guillaume@ubuntu:~/0x11$ ./10-my_github.py edwardmuss wrong_pwd
None
$ guillaume@ubuntu:~/0x11$
```
...
Author: [Dovine Owuor](https://linkedin.com/in/dovine-owuor)